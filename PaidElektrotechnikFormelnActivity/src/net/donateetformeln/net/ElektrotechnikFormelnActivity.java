package net.donateetformeln.net;
...
public class ElektrotechnikFormelnActivity extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getResources().getDrawable(R.drawable.formeltabicon);
		th.addTab(specs);
    ...
    public void formelseitewechselnohmischesgesetz(View view) {
    	startActivity(new Intent("net.donateetformeln.net.OHMISCHESGESETZ"));
    }
    public void formelseitewechselnwiederstandundleitwert(View view) {
    	startActivity(new Intent("net.donateetformeln.net.WIEDERSTANDUNDLEITWERT"));
    }
    public void seitewechselnkirchhoffschesgesetz(View view) {
    	startActivity(new Intent("net.donateetformeln.net.kirchhofschesgesetz"));
    }
    public void hauptmenu(View view) {
    	setContentView(R.layout.main);
    }
    public void seitewechselnstromdichte(View view) {
    	startActivity(new Intent("net.donateetformeln.net.stromdichte"));
    }
    public void seitewechselnwiederstandundmaterial(View view) {
    	startActivity(new Intent("net.donateetformeln.net.wiederstandundmaterial"));
    }
    public void seitewechselnelstromstaerke(View view) {
    	startActivity(new Intent("net.donateetformeln.net.elstromstaerke"));
    }
    public void seitewechselnleistung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.leistung"));
    }
    public void seitewechselnzugfestigkeit(View view) {
    	startActivity(new Intent("net.donateetformeln.net.zugfestigkeit"));
    }
    public void seitewechselnwirkungsgrad(View view) {
    	startActivity(new Intent("net.donateetformeln.net.wirkungsgrad"));
    }
    public void seitewechselnserieschaltung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.serieschaltung"));
    }
    public void seitewechselnparallelschaltung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.parallelschaltung"));
    }
    public void seitewechselngalvanischeselement(View view) {
    	startActivity(new Intent("net.donateetformeln.net.galvanischeselement"));
    }
    public void seitewechselnmagnetischedurchflutung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.magnetischedurchflutung"));
    }
    public void seitewechselnkosten(View view) {
    	startActivity(new Intent("net.donateetformeln.net.kosten"));
    }
    public void seitewechselninduktionsgesetz(View view) {
    	startActivity(new Intent("net.donateetformeln.net.induktion"));
    }
    public void seitewechselnfrequndperio(View view) {
    	startActivity(new Intent("net.donateetformeln.net.frequenzperioden"));
    }
    public void seitewechselnsterndreieck(View view) {
    	startActivity(new Intent("net.donateetformeln.net.sterndreieck"));
    }
    public void seitewechselntransformator(View view) {
    	startActivity(new Intent("net.donateetformeln.net.transformator"));
    }
    public void seitewechselnleistungsbestimmung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.leistungsbestimmung"));
    }
    public void seitewechselnwaerme(View view) {
    	startActivity(new Intent("net.donateetformeln.net.waerme"));
    }
    public void seitewechselnwirkleistung(View view) {
    	startActivity(new Intent("net.donateetformeln.net.wirkleistung"));
    }
    public void formelsenden(View view) {
    	startActivity(new Intent("net.donateetformeln.net.FORMELSENDENEMAIL"));
    }
    public void seitewechselnkondensator(View view) {
    	startActivity(new Intent("net.donateetformeln.net.kondensator"));
    }
    public void leistungsdreieckwechseln(View view) {
    	startActivity(new Intent("net.donateetformeln.net.leistungsdreieck"));
    }
    public void tempwiederstandwechselm(View view) {
    	startActivity(new Intent("net.donateetformeln.net.tempwiderstand"));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	case R.id.Infos:
    		startActivity(new Intent("net.donateetformeln.net.infos"));	
